        ...
        <form method="POST" enctype="multipart/form-data" action="search.app.php" autocomplete="off">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <select style=" width: 100%; border: 2px solid grey ;" class="select2 form-select" name="university" style="width: 100%;">
      ...
      <div class="card-body form-control ">
        <form method="POST" enctype="multipart/form-data" action="school_input.php" autocomplete="off">
          <div class="row">
            ...
            <div class="">
              <label for="">Department</label>
              <select class=" select2 form-select" name="faculty" id="faculty" style=" width: 100%; border: 2px solid grey ;">
                <option value="">Select Department</option>
                <?php
                foreach ($departments as $department) {
                  echo "<option value='$department'>$department</option>";
